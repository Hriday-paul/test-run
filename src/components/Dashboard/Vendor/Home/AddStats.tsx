        ...
        <div>
            <div className="grid grid-cols-2 lg:grid-cols-3 gap-5 w-full min-w-0">
                {isLoading ? <>
                    ...
                    <div className="flex flex-col px-6 py-2 bg-white shadow-2 rounded overflow-hidden border border-stroke">
                        <div className="flex flex-col items-center space-y-2 py-3">
                            <div className="text-2xl md:text-4xl font-semibold tracking-tight leading-none text-primary font-popin">{data?.data?.featured} / {data?.data?.feature_count}</div>
                    ...
                    <div className="flex flex-col px-6 py-2 bg-white shadow-2 rounded overflow-hidden border border-stroke">
                        <div className="flex flex-col items-center space-y-2 py-3">
                            <div className="text-2xl md:text-4xl font-semibold tracking-tight leading-none text-primary font-popin">{data?.data?.bumped} / {data?.data?.bump_count}</div>
