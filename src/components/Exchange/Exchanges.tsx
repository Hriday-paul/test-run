...
import { useAllBikesQuery, useAllExchangesQuery, useAllJobsQuery, useAllLawyersQuery } from "@/redux/api/ads.api"
...
function Exchanges() {
    ...
    const { isLoading, isError, isSuccess, data } = useAllExchangesQuery(query);
    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                {isSuccess && data?.data?.data?.map(Exchange => {
