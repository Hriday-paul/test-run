  ...
  return (
    <section className="py-16 bg-gray-50">
      <div className="max-w-6xl mx-auto px-6 text-center">
        <div className="text-[#183B56] text-center space-y-5 mb-12">
          <h2 className="text-5xl font-bold">Our pricing plan made simple</h2>
          <p className="font-normal text-xl ">
            All types of businesses need access to development resources, so we
            give you <br /> the option to decide how much you need to use.
          </p>
        </div>
