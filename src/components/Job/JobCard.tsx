                    ...
                    <div className="flex items-center justify-between text-gray-700 text-sm py-2">
                        <div className="flex flex-col justify-between items-start gap-3">
                            <span className="flex items-center gap-1 text-base">
                                <RiMoneyDollarBoxLine size={22} /> {job?.job?.salary || "N/A"}
                            </span>
                            <span className="flex items-center text-base gap-1">
                                <SlLocationPin size={22} /> {job?.job?.job_location || "N/A"}
                            </span>
                        </div>
                        <div className="flex flex-col justify-between items-start gap-3">
                            <span className="flex items-center gap-1 text-base">
                                <MdOutlineWorkOutline size={20} /> {job?.job?.job_type || "N/A"}
                            </span>
                            <span className="flex items-center gap-1 text-base">
                                <GrUserWorker size={20} /> {job?.job?.employment_type || "N/A"}
                            </span>
                        </div>
                    </div>
