            ...
            <form onSubmit={handleSubmit(handleFormSubmit)} className=''>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-5'>
                    <div className="w-full mx-auto mb-4">
                        <label htmlFor='workshoptype' className="mb-1.5 block text-black dark:text-white font-popin text-base">
                            Workshop Type
                            <span className="text-red-500 text-base ml-1">*</span>
                        </label>
                        ...
                        />
                        {errors?.workshop_type && <p className="text-red-500 text-sm col-span-2 font-popin">{errors?.workshop_type?.message}</p>}
                    </div>
                    <div className="w-full mx-auto mb-4">
                        ...
                        <input
                            ...
                            className={`w-full rounded bg-white border py-2.5 px-4 text-black outline-none transition disabled:opacity-50 disabled:cursor-not-allowed disabled:bg-white font-popin placeholder:font-popin ${errors?.address ? 'border-primary' : ' border-strokeinput focus:border-black active:border-black'}`}
                        />
                        {errors?.address && <p className="text-red-500 text-sm col-span-2 font-popin">{errors?.address?.message}</p>}
                    </div>
                </div>

                <div className='grid grid-cols-1 md:grid-cols-2 gap-5'>
                    <div className="w-full mx-auto mb-4">
                        <label htmlFor='opentime' className="mb-1.5 block text-black dark:text-white font-popin text-base">
                            Open Time
                            {/* <span className="text-red-500 text-base ml-1">*</span> */}
                        </label>
                        <input
                            ...
                            className={`w-full rounded bg-white border py-2.5 px-4 text-black outline-none transition disabled:opacity-50 disabled:cursor-not-allowed disabled:bg-white font-popin placeholder:font-popin ${errors?.open_time ? 'border-primary' : ' border-strokeinput focus:border-black active:border-black'}`}
                        />
                        {errors?.open_time && <p className="text-red-500 text-sm col-span-2 font-popin">{errors?.open_time?.message}</p>}
                    </div>

                    <div className="w-full mx-auto mb-3">
                        <label htmlFor='close_time' className="mb-1.5 block text-black dark:text-white font-popin">
                            Close time
                            {/* <span className="text-red-500 text-base ml-1">*</span> */}
                        </label>
                        <input
