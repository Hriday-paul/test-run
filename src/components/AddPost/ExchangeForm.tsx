            ...
            <form onSubmit={handleSubmit(handleFormSubmit)} className=''>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-5'>
                    <div className="w-full mx-auto mb-4">
                        <label htmlFor='exchange_category' className="mb-1.5 block text-black dark:text-white font-popin text-base">
                            Category
                            <span className="text-red-500 text-base ml-1">*</span>
                        </label>
                        ...
                        <SelectWithSearch
                            ...
                            items={ExchangeCategory.map(type => {
                        ...
                        />
                        {errors?.exchange_category && <p className="text-red-500 text-sm col-span-2 font-popin">{errors?.exchange_category?.message}</p>}
                    </div>
                    <div className="w-full mx-auto mb-4">
                        <label htmlFor='wanted_category' className="mb-1.5 block text-black dark:text-white font-popin text-base">
                            Want by
                            <span className="text-red-500 text-base ml-1">*</span>
                        </label>

                        <SelectWithSearch
                            name='wanted_category'
                            items={ExchangeCategory.map(type => {
                                return { label: type, value: type }
                            })}
                            control={control}
                        ...
                        />
                        {errors?.wanted_category && <p className="text-red-500 text-sm col-span-2 font-popin">{errors?.wanted_category?.message}</p>}
                    </div>
                </div>
