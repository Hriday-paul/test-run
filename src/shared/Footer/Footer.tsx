                ...
                <div className="mx-auto w-full max-w-[1166px] px-4 xl:px-0">
                    <div className="flex flex-col justify-between sm:px-[18px] md:flex-row md:px-10">
                        <div className="md:w-[316px]">
                            ...
                            <span className="text-[14px] font-normal text-white/70">[Developed by <Link className="underline text-blue-500 underline-offset-2" target="_blank"
                            ...
                            <div className="mt-4 flex gap-4">
                                ...
                                <Link
                                    className="hover:bg-slate-50 duration-150 bg-white p-2 rounded-full" target="_blank"
                                    href="/">
                                    <FaTwitter size={15} />
                                </Link>
                                <Link
                    ...
                    <div className="flex items-center justify-center pb-8 pt-[9px] md:py-8 border-t border-t-gray-800 mt-12">
                        <Image src={payments} alt='logo' className='h-auto w-auto md:max-w-3/4 object-cover mx-auto' />
                    </div>
                </div>
            </div>
        </footer>
