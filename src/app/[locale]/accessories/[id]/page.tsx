...
async function AccessoriesDetil({ params }: { params: Promise<{ id: string }> }) {
  const { id } = await params;
  ...
  return (
    <div>
      ...
      >
        ...
        <Link href='/accessories' className='text-primary'>Accessories</Link>
        <IoIosArrowForward className='' /> Accessories Details
      </ShopBanner>

      <Suspense fallback={<DetailsSkeleton />}>
        <AccessoriesDetails promiseAdDetails={promiseAdDetails} />
      </Suspense>
...
export default AccessoriesDetil