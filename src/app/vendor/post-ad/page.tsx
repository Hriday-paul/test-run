         ...
         <div className="grid grid-cols-1 md:grid-cols-2  border border-stroke max-w-2xl mx-auto mt-8">
            {
                categories?.map(category=>{
                    return <Link href={category?.rout} key={category?.id} className="flex flex-row items-center justify-between gap-3 py-5 px-4 border border-stroke hover:bg-slate-100 duration-150">
