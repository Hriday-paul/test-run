...
import ExchangeForm from '@/components/AddPost/ExchangeForm'
...
function CarSell() {
    return (
        <div>
            <Pagetop title='Exchange'>
                <h3 className="text-xs md:text-sm font-figtree text-gray-500 flex flex-row gap-x-1.5 justify-center items-center">
                    <Link href='/' className='text-primary'>Home</Link> <IoIosArrowForward className='' /> <Link href='/vendor/post-ad' className='text-primary'>Post</Link> <IoIosArrowForward className='' /> Exchange
                </h3>
            </Pagetop>
