  ...
  return (
    <div>
      ...
      >
        ...
        <Link href='/car-rent' className='text-primary'>Car Rents</Link>
        <IoIosArrowForward className='' /> Car Rent Details
      </ShopBanner>

      <Suspense fallback={<DetailsSkeleton />}>
        <RentCarDetails promiseAdDetails={promiseAdDetails} />
      </Suspense>
